...
inline float StHFTriplet::rapidity()    const { return mLorentzVector.Rapidity();}
inline float StHFTriplet::m()    const { return mLorentzVector.M();}
inline float StHFTriplet::pt()   const { return mLorentzVector.Pt();}
inline float StHFTriplet::eta()  const { return mLorentzVector.Eta();}
